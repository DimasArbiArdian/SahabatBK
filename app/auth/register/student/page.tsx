      ...
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-black">
          ...
          <input
            type="text"
            name="studentId"
            placeholder="NIS (Nomor Induk Siswa)" // Translated (NIS is common, but providing full form is good)
          ...
          <input
            type="text"
            name="phoneNumber"
            placeholder="Nomor Telepon (Harus diawali dengan 62)" // Translated
